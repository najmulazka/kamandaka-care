  ...
  return (
    <div className="">
      ...
      <div className="p-4 lg:px-8">
        ...
        <div className="mb-1">1. Mulai proses pemesanan dengan menekan tombol Konsultasi</div>
      ...
      <div className="p-4 lg:px-8">
        ...
        <div className="mb-1">1. Mulai proses pemesanan dengan menekan tombol Tes Psikologi</div>
