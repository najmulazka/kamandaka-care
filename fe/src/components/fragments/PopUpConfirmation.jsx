const PopUpConfirmation = (props) => {
  ...
  return (
    <div>
      {/* <!-- Main modal --> */}
      <div id="deleteModal" tabIndex="-1" aria-hidden="true" className="fixed inset-0 flex bg-gray-900 bg-opacity-50 z-50 justify-center items-center w-screen h-screen">
